...
class Toolbar(QMenuBar, Plugin):
    ...
    def setUp_actions(self):
        ...
        self.numpy_unwrap = self.create_numpy_unwrap()
        ...
        self.unwrap_menu.addAction(self.numpy_unwrap)
    ...
    def create_numpy_unwrap(self):
        # creating ae action to add to the file menu
        numpy_unwrap = QAction("Numpy unwrap", self)
        numpy_unwrap.setCheckable(True)
        numpy_unwrap.setStatusTip("numpy's unwrapping method")
        numpy_unwrap.triggered.connect(self.set_numpy_unwrap)
        return numpy_unwrap

    def set_numpy_unwrap(self):
        self.uncheck_all()
        self.numpy_unwrap.setChecked(True)
        self.selected_unwrap_method = "numpy"
    ...
    def TIE_settings(self):
        ...
        self.pixel_size_spinbox.setPrefix("Pixel size (μm): ")
        self.pixel_size_spinbox.setRange(0, 1000)
        self.pixel_size_spinbox.setValue(6.5)
        ...
        self.wavelength_spinbox.setPrefix("Wavelength (nm): ")
        self.wavelength_spinbox.setRange(1, 5000)
        self.wavelength_spinbox.setValue(660)
