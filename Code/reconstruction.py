...
class reconstruction(QWidget, Plugin):
    ...
    def updatevalues(self):
        ...
        self.kwargs = {
            "pixel_size": self.pluginDict[ToolBar_name].pixel_size,
            "wavelength": self.pluginDict[ToolBar_name].wavelength,
        }
        print(self.unwrap_method)
